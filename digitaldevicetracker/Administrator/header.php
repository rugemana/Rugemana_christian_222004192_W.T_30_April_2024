        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="list_devices.php" style="color: white;">Devices</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="list-AvailableRequest.php" style="color: white;">Borrower's request</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="list-AvailableNotReturned.php" style="color: white;">Devices Borrowed</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="list-AvailableReturned.php" style="color: white;">Devicesn Returned</a>
                    </li>
                    <li class="nav-item">
